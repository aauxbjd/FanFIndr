...
// to check logged in
	...
	function contactus(){
		global $db;
		$contactemail       =  e($_POST['emailcontact']);
        $contactquestion       =  e($_POST['questioncontact']);
		$query = "INSERT INTO Contactus (email, question)
						  VALUES('$contactemail','$contactquestion')";
				mysqli_query($db, $query);
	}
...
$google_client->setClientId('292779951647-db4m6l1813cjtq0943gbp0l3psne3l4m.apps.googleusercontent.com');

//Set the OAuth 2.0 Client Secret key
$google_client->setClientSecret('pDRw5a15M21IUnzBzWcanD8W');

//Set the OAuth 2.0 Redirect URI
$google_client->setRedirectUri('http://localhost:8080/Final-Project-CSCI426-master/Our-Project/google.php');
