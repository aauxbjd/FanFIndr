        ...
        <div class="container">
          ...
          <nav id="nav-menu-container">
            <ul class="nav-menu">
              ...
              <li>
                  <div class="dropdown">
                      <a href="businesslogin.html" class="dropbtn">Sign In/Up</a>
        ...
        <div class="limiter">
            <div class="container-login100" style="background-color: rgb(255, 255, 255);"> <!-- This controls the background and scaling of the sign in and sign up page >>main.css-->
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33"> <!-- This is a login box >>main.css -->
                    <form class="login100-form validate-form flex-sb flex-w"> <!-- This is for the form itself >>main.css -->
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Username is required">
                            <input class="input100" type="text" name="bussname" id="bussname">
                        ...
                        <div class="w-full text-center p-t-55">
                            ...
                            <a href="businesssignup.php" class="txt2 bo1">
